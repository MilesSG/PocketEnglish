...
public class MainActivity extends AppCompatActivity {
    ...
    private RadioButton rbFour,rbSix,rbText;
    ...
    protected void onResume() {
        super.onResume();
        if(SPUtils.get(MainActivity.this,"planname","")!=null){
            filename = (String) SPUtils.get(this,"planname","");
            setjihua(filename);
//            if(filename.contains("四级")){
//                rbFour.setChecked(true);
//            }
//            if(filename.contains("六级")){
//                rbSix.setChecked(true);
//            }
//            if(filename.contains("test")){
//                rbText.setChecked(true);
//            }
        }
        sp.setText((String) SPUtils.get(this,"mrdcs",""));
        day_tv.setText((String) SPUtils.get(this,"day",""));
    }
    ...
    public void init(){
        ...
        rbFour = (RadioButton)findViewById(R.id.siji_rtb);
        rbSix = (RadioButton)findViewById(R.id.liuji_rtb);
        rbText = (RadioButton)findViewById(R.id.tuofu_rtb);
    ...
    public void showDialog(String planname,int sum_num,int num){
        ...
        setPlanDialog.setPositiveButton("设置/修改",new DialogInterface.OnClickListener(){
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                SPUtils.put(MainActivity.this, "mrdcs", sp.getText().toString());
                day_tv.setText(tempdays+hfdst+"天");
                SPUtils.put(MainActivity.this, "day", day_tv.getText().toString());
        ...
        setPlanDialog.setNegativeButton("取消", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                mrdcs = num;
                hfdst = sum_num/num;
                sp.setText(String.valueOf(mrdcs)+"个");
                SPUtils.put(MainActivity.this, "mrdcs", sp.getText().toString());
                day_tv.setText(tempdays+hfdst+"天");
                SPUtils.put(MainActivity.this, "day", day_tv.getText().toString());
                cunchujihua(filename,mrdcs);
